...
\textsc{\large Esperienza 1}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries MISURE VOLT -\\[0.4cm]AMPEROMETRICHE}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Autori:}\\
Biasi Lorenzo\\Canteri Marco\\Damiani Emily % Your name
\end{flushleft}
\end{minipage}
~
\begin{minipage}{0.4\textwidth}
